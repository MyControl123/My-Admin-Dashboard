...
var options = {
    ...
    plotOptions: {
      boxPlot: {
        colors: {
          upper: (chartBarColors = getChartColorsArray("basic_box"))[0],
          lower: chartBarColors[1],
        },
      },
    },
  },
  chart = new ApexCharts(document.querySelector("#basic_box"), options);
chart.render();
var chartBarColors = getChartColorsArray("box_plot"),
  options = {
    ...
    plotOptions: {
      boxPlot: { colors: { upper: "#f1734f", lower: "#564ab1" } },
    },
