...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("multiple_radialbar")),
};
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("circle_radialbar")),
...
options = {
  ...
  stroke: { dashArray: 4 },
  labels: ["Median Ratio"],
  colors: (chartBarColors = getChartColorsArray("stroked_radialbar")),
};
(chart = new ApexCharts(
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("semi_radialbar")),
};
(chart = new ApexCharts(
