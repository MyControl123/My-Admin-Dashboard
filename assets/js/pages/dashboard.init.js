...
chart.render();
options = {
  chart: { height: 159, type: "area", toolbar: { show: !1 } },
...
options = {
  ...
  series: [
    { name: "Net Profit", data: [95, 40, 73, 60, 51, 37, 30] },
    { name: "Revenue", data: [75, 26, 53, 44, 37, 26, 23] },
  ],
...
var sparklineoptions1 = {
    ...
    chart: { type: "area", width: 120, height: 40, sparkline: { enabled: !0 } },
    fill: {
      type: "gradient",
      gradient: {
        shadeIntensity: 1,
...
options = {
  ...
  chart: { type: "bar", height: 234, toolbar: { show: !1 } },
  labels: ["Canada", "Russia", "Brazil", "United States", "Egypt"],
  colors: ["#3EB3F2"],
  plotOptions: { bar: { borderRadius: 3, horizontal: !0 } },
  dataLabels: { enabled: !1 },
