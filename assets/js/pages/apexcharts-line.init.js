...
var options = {
    ...
    colors: (chartBarColors = getChartColorsArray("line_chart_basic")),
    title: {
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("line_chart_datalabel")),
  dataLabels: { enabled: !1 },
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("line_chart_dashed")),
  dataLabels: { enabled: !1 },
...
(chartBarColors = getChartColorsArray("line_chart_annotations")),
  (options = {
...
(chartBarColors = getChartColorsArray("syncingchart-line")),
  (options = {
    series: [
      {
...
var data = generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 185, {
  ...
  chartBarColors = getChartColorsArray("brushchart_line2"),
  options = {
    series: [{ data: data }],
    chart: {
      id: "chart2",
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("line_chart_stepline")),
};
(chart = new ApexCharts(
...
options = {
  ...
  markers: {
    size: 4,
    colors: (chartBarColors = getChartColorsArray("line_chart_gradient")),
    strokeColors: "#fff",
    strokeWidth: 2,
    hover: { size: 7 },
  },
...
options = {
  ...
  xaxis: {},
  colors: (chartBarColors = getChartColorsArray("line_chart_missing_data")),
};
(chart = new ApexCharts(
...
function getDayWiseTimeSeries(e, t, a) {
  for (var r = 0; r < t; ) {
    ...
    data.push({ x: n, y: i }), (lastDate = e), (e += TICKINTERVAL), r++;
  }
}
...
(chartBarColors = getChartColorsArray("line_chart_realtime")),
  (options = {
