...
var chartBarColors = getChartColorsArray("basic_treemap"),
  ...
  chart = new ApexCharts(document.querySelector("#basic_treemap"), options);
chart.render();
options = {
  series: [
    {
  ...
  colors: (chartBarColors = getChartColorsArray("multi_treemap")),
};
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("distributed_treemap")),
    ...
    treemap: {
      ...
      colorScale: {
        ranges: [
          ...
          { from: 0.001, to: 6, color: chartBarColors[1] },
        ],
      },
    },
  },
