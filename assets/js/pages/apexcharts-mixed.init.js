...
var chartBarColors = getChartColorsArray("line_column_chart"),
  ...
  chart = new ApexCharts(document.querySelector("#line_column_chart"), options);
chart.render();
options = {
  series: [
    {
  ...
  colors: (chartBarColors = getChartColorsArray("multi_chart")),
};
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("line_area_chart")),
};
(chart = new ApexCharts(
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("line_area_charts")),
};
(chart = new ApexCharts(
