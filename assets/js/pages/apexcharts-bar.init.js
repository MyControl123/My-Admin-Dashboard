...
var options = {
    ...
    colors: (chartBarColors = getChartColorsArray("bar_chart")),
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("custom_datalabels_bar")),
  dataLabels: {
    enabled: !0,
    textAnchor: "start",
    style: { colors: ["#fff"] },
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("stacked_bar")),
};
(chart = new ApexCharts(
...
options = {
  ...
  fill: { opacity: 1 },
  legend: { position: "top", horizontalAlign: "left", offsetX: 40 },
  colors: (chartBarColors = getChartColorsArray("stacked_bar_100")),
};
(chart = new ApexCharts(
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("negative_bars")),
  ...
  yaxis: {
    min: -5,
    max: 5,
    title: { text: "Age", style: { fontWeight: 600 } },
  },
  tooltip: {
    shared: !1,
    x: {
...
options = {
  ...
  chart: { height: 350, type: "bar", toolbar: { show: !1 } },
  plotOptions: { bar: { horizontal: !0 } },
  colors: (chartBarColors = getChartColorsArray("bar_markers")),
  dataLabels: {
    formatter: function (t, e) {
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("patterned_bars")),
};
(chart = new ApexCharts(
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("grouped_bar")),
};
(chart = new ApexCharts(
  document.querySelector("#grouped_bar"),
  options
)).render();
(chartBarColors = getChartColorsArray("bar_images")),
  (options = {
    series: [
      {
        name: "coins",
