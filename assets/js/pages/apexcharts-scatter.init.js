...
var options = {
    ...
    yaxis: { tickAmount: 7 },
    colors: (chartBarColors = getChartColorsArray("basic_scatter")),
  },
  chart = new ApexCharts(document.querySelector("#basic_scatter"), options);
chart.render();
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("images_scatter")),
